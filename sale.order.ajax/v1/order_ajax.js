    ...
    BX.Sale &&
      ...
      (BX.Sale.Input.Utils.asMultiple = function (value) {
        ...
        if (value.constructor === Array) {
          for (var i = 0, length = value.length, val; i < length; )
            null == (val = value[i]) || "" === val
              ? (value.splice(i, 1), --length)
              : ++i;
      ...
      (BX.Sale.OrderAjaxComponent = {
        initializePrimaryFields: function () {
          (this.BXFormPosting = !1),
            (this.regionBlockNotEmpty = !1),
            (this.locationsInitialized = !1),
            (this.locations = {}),
            (this.cleanLocations = {}),
            (this.locationsTemplate = ""),
            (this.pickUpMapFocused = !1),
            (this.options = {}),
            ...
            (this.isHttps = "https:" === window.location.protocol),
            (this.orderSaveAllowed = !1),
            (this.socServiceHiddenNode = !1),
            (this.isDeliveryChanged = !1);
        },
        init: function (parameters) {
          this.initializePrimaryFields(),
            ...
            (this.defaultStoreLogo =
              this.templateFolder + "/images/pickup_logo.png"),
            ...
            (this.mobileTotalBlockNode = BX(
              parameters.totalBlockId + "-mobile"
            )),
            ...
            (this.basketHiddenBlockNode = BX(
              parameters.basketBlockId + "-hidden"
            )),
            (this.regionBlockNode = BX(parameters.regionBlockId)),
            (this.regionHiddenBlockNode = BX(
              parameters.regionBlockId + "-hidden"
            )),
            ...
            (this.deliveryHiddenBlockNode = BX(
              parameters.deliveryBlockId + "-hidden"
            )),
            (this.pickUpBlockNode = BX(parameters.pickUpBlockId)),
            (this.pickUpHiddenBlockNode = BX(
              parameters.pickUpBlockId + "-hidden"
            )),
            (this.propsBlockNode = BX(parameters.propsBlockId)),
            (this.propsHiddenBlockNode = BX(
              parameters.propsBlockId + "-hidden"
            )),
            this.result.SHOW_AUTH &&
              ...
              (this.authGenerateUser =
                "Y" !==
                  this.result.AUTH.new_user_registration_email_confirmation &&
                "Y" !== this.result.AUTH.new_user_phone_required)),
            this.totalBlockNode &&
            ...
            (this.result.IS_AUTHORIZED &&
              void 0 === this.result.LAST_ORDER_DATA.FAIL) ||
            ...
            "Y" === this.params.USE_ENHANCED_ECOMMERCE &&
              this.setAnalyticsDataLayer("checkout"),
            "Y" === this.params.USER_CONSENT && this.initUserConsent();
        },
        sendRequest: function (action, actionData) {
          ...
          this.startLoader() &&
            ((this.firstLoad = !1),
            "saveOrderAjax" ===
            (action = BX.type.isNotEmptyString(action)
              ? action
              : "refreshOrderAjax")
        ...
        getData: function (action, actionData) {
          ...
          return (
            ...
            ("enterCoupon" !== action && "removeCoupon" !== action) ||
        ...
        getAllFormData: function () {
          ...
          for (i in prepared.data)
            prepared.data.hasOwnProperty(i) &&
              "" == i &&
        ...
        refreshOrder: function (result) {
          if (result.error)
            ...
            this.addAnimationEffect(this.authBlockNode, animation),
              ...
              this.editAuthBlock(),
              this.showAuthBlock(),
              this.showErrors(result.order.ERROR, !1),
            ...
            if (
              ...
              this.isDeliveryChanged
                ...
                : this.activeSectionId !== this.deliveryBlockNode.id &&
                  (this.deliveryCachedInfo = []),
              result.order.PAY_CURRENT_ACCOUNT &&
                "Y" === result.order.PAY_CURRENT_ACCOUNT)
            ) {
            ...
            (this.result = result.order),
              ...
              (this.locationsInitialized = !1),
              (this.maxWaitTimeExpired = !1),
              (this.pickUpMapFocused = !1),
              (this.deliveryLocationInfo = {}),
              (this.initialized = {}),
              (this.couponsCustomInitialized = !1),
              this.initOptions(),
              this.editOrder(),
        ...
        saveOrderWithJson: function (result) {
          ...
          result &&
            result.order &&
            ((result = result.order).REDIRECT_URL
              ? ("Y" === this.params.USE_ENHANCED_ECOMMERCE &&
              ...
              ? ((this.result.SHOW_AUTH = result.SHOW_AUTH),
                ...
                this.showAuthBlock(),
                this.animateScrollTo(this.authBlockNode))
              : this.showErrors(result.ERROR, !0, !0)),
            redirected || this.handleNotRedirected();
        },
        ...
        startLoader: function () {
          return (
            !0 !== this.BXFormPosting &&
            ((this.BXFormPosting = !0),
            this.loadingScreen ||
              ((this.loadingScreen = new BX.PopupWindow(
                "loading_screen",
                null,
                {
                  ...
                  events: {
                    onAfterPopupShow: BX.delegate(function () {
                      BX.cleanNode(this.loadingScreen.popupContainer),
                        BX.removeClass(
                          this.loadingScreen.popupContainer,
                          "popup-window"
                        ),
                        ...
                        this.loadingScreen.popupContainer.removeAttribute(
                          "style"
                        ),
                        (this.loadingScreen.popupContainer.style.display =
                          "block");
                    }, this),
                  },
                }
              ...
              BX.addClass(
                this.loadingScreen.overlay.element,
                "bx-step-opacity"
              )),
        ...
        animateScrollTo: function (node, duration, shiftToTop) {
          if (node) {
            ...
            shiftToTop && (ghostTop -= parseInt(shiftToTop)),
              ghostTop + window.innerHeight > orderBlockPos.bottom &&
        ...
        checkKeyPress: function (event) {
          if (13 == event.keyCode) {
            var target = event.target || event.srcElement,
              ...
              nextAttr,
              next;
            if (!target.getAttribute("data-send"))
              return (
        ...
        getSizeString: function (maxSize, len) {
          ...
          return (
            ...
            (str =
              maxSize > gbDivider
                ? parseFloat(maxSize / gbDivider).toFixed(len) + " Gb"
                : maxSize > 1048576
                ? parseFloat(maxSize / 1048576).toFixed(len) + " Mb"
                : maxSize > 1024
                ? parseFloat(maxSize / 1024).toFixed(len) + " Kb"
                : maxSize + " B")
          );
        },
        getFileAccepts: function (accepts) {
          ...
          for (i = 0; i < arAccepts.length; i++)
            (currentAccept =
              mimeTypesMap[(currentAccept = BX.util.trim(arAccepts[i]))] ||
              currentAccept),
        ...
        uniqueText: function (text, separator) {
          ...
          for (
            separator = separator || "<br>",
              phrases = (text = text || "").split(separator),
              phrases = BX.util.array_unique(phrases),
              i = 0;
            i < phrases.length;
            i++
          )
            "" != phrases[i] && output.push(BX.util.trim(phrases[i]));
        ...
        showError: function (node, msg, border) {
          ...
          errorContainer &&
            ...
            (animate = !this.hasErrorSection[node.id])
              ...
              : (errorContainer.style.display = ""),
            border && BX.addClass(node, "bx-step-error"));
        },
        showErrors: function (errors, scroll, showAll) {
          ...
          for (k = 0; k < errorNodes.length; k++)
            (section = BX.findParent(errorNodes[k], {
          ...
          if (errors && !(BX.util.object_keys(errors).length < 1)) {
            for (k in errors)
              if (errors.hasOwnProperty(k))
                switch (((blockErrors = errors[k]), k.toUpperCase())) {
                  case "MAIN":
                    ...
                    break;
                  case "AUTH":
                    "none" == this.authBlockNode.style.display
                      ? (this.showError(this.mainErrorsNode, blockErrors, !0),
                        this.animateScrollTo(this.mainErrorsNode, 800, 20),
                        (scroll = !1))
                      : this.showError(this.authBlockNode, blockErrors, !0);
                    break;
                  case "REGION":
                    (showAll ||
                      "true" ===
                        this.regionBlockNode.getAttribute("data-visited")) &&
                      (this.showError(this.regionBlockNode, blockErrors, !0),
                      this.showError(this.regionHiddenBlockNode, blockErrors));
                    break;
                  case "DELIVERY":
                    (showAll ||
                      "true" ===
                        this.deliveryBlockNode.getAttribute("data-visited")) &&
                      (this.showError(this.deliveryBlockNode, blockErrors, !0),
                      this.showError(
                  ...
                  case "PAY_SYSTEM":
                    (showAll ||
                      "true" ===
                        this.paySystemBlockNode.getAttribute("data-visited")) &&
                      (this.showError(this.paySystemBlockNode, blockErrors, !0),
                      this.showError(
                  ...
                  case "PROPERTY":
                    (showAll ||
                      "true" ===
                        this.propsBlockNode.getAttribute("data-visited")) &&
                      (this.showError(this.propsBlockNode, blockErrors, !0),
        ...
        showBlockErrors: function (node) {
          ...
          if (errorNode) {
            ...
            errors &&
              BX.util.object_keys(errors).length &&
              (this.showError(node, errors, !0),
        ...
        checkPreload: function (node) {
          ...
          switch (node.id) {
            ...
            case this.deliveryBlockNode.id:
              status =
                this.result.LAST_ORDER_DATA &&
                this.result.LAST_ORDER_DATA.DELIVERY;
              break;
            case this.pickUpBlockNode.id:
              status =
                this.result.LAST_ORDER_DATA &&
                this.result.LAST_ORDER_DATA.PICK_UP;
              break;
            default:
              status = !0;
          }
        ...
        checkBlockErrors: function (node) {
          ...
          if (
            (hiddenNode = BX(node.id + "-hidden")) &&
            ((showError =
              (errorNode = hiddenNode.querySelector(
                "div.alert.alert-danger"
              )) && "none" != errorNode.style.display),
            ...
            for (
              errorTooltips = hiddenNode.querySelectorAll("div.tooltip"), i = 0;
              i < errorTooltips.length;
              i++
            )
              if ("opened" == errorTooltips[i].getAttribute("data-state")) {
                showError = !0;
                break;
              }
          return (
        ...
        showWarnings: function () {
          ...
          for (k = 0; k < sections.length; k++)
            BX.removeClass(sections[k], "bx-step-warning"),
              "false" == sections[k].getAttribute("data-visited") &&
                BX.removeClass(sections[k], "bx-step-completed");
          if (
            (currentDelivery && currentDelivery.CALCULATE_ERRORS
              ? (BX.addClass(this.deliveryBlockNode, "bx-step-warning"),
                (warningString =
                  "<strong>" +
                  this.params.MESS_DELIVERY_CALC_ERROR_TITLE +
                  "</strong>"),
                this.params.MESS_DELIVERY_CALC_ERROR_TEXT.length &&
                  (warningString +=
                    "<br><small>" +
            ...
            this.result.WARNING && this.options.showWarnings)
          )
        ...
        showBlockWarning: function (node, warnings, hide) {
          var errorNode = node.querySelector(".alert.alert-danger"),
            ...
            existedWarningNodes;
          if (errorNode) {
            if (BX.type.isString(warnings)) warnStr = warnings;
            else
              for (i in warnings)
                warnings.hasOwnProperty(i) &&
                  warnings[i] &&
                  (warnStr += warnings[i] + "<br>");
            if (!warnStr) return;
            for (i in (existedWarningNodes = node.querySelectorAll(
              ".alert.alert-warning"
            )))
              if (
                existedWarningNodes.hasOwnProperty(i) &&
                BX.type.isDomNode(existedWarningNodes[i]) &&
                -1 !== existedWarningNodes[i].innerHTML.indexOf(warnStr)
              )
                return;
            ...
            if (pagination.pages.length > 1) {
              for (
                navigation.push(
                  ...
                  i = 0;
                i < pagination.pages.length;
                i++
              )
                (active =
                  (pageCounter = parseInt(i) + 1) == pagination.pageNumber
                    ? "bx-active"
                    : ""),
                  navigation.push(
                    BX.create("LI", {
        ...
        doPagination: function (e) {
          var target = e.target || e.srcElement,
            ...
            pageNum;
          return BX.hasClass(node, "bx-active")
            ? BX.PreventDefault(e)
            : (("prev" != page && "next" != page) ||
                ((pageNum = parseInt(
                  BX.findParent(node)
                ...
                (page = "next" == page ? ++pageNum : --pageNum)),
              "delivery" == entity
                ? this.showDeliveryItemsPage(page)
                : "paySystem" == entity
                ? this.showPaySystemItemsPage(page)
                : "pickUp" == entity && this.showPickUpItemsPage(page),
              BX.PreventDefault(e));
        },
        showDeliveryItemsPage: function (page) {
          ...
          for (
            selectedDelivery &&
              ...
              BX.type.isDomNode(hidden) &&
                BX.prepend(hidden, BX.findParent(deliveryItemsContainer)),
              k = 0;
            k < this.deliveryPagination.currentPage.length;
            k++
          )
        ...
        showPaySystemItemsPage: function (page) {
          ...
          for (
            selectedPaySystem &&
              ...
              k = 0;
            k < this.paySystemPagination.currentPage.length;
            k++
          )
        ...
        initPropsListForLocation: function () {
          ...
          if (
            ...
            for (
              BX.saleOrderAjax.cleanUp(), i = 0;
              i < this.result.ORDER_PROP.properties.length;
              i++
            )
              if (
                "LOCATION" ==
                  (curProp = this.result.ORDER_PROP.properties[i]).TYPE &&
                "Y" == curProp.MULTIPLE &&
                "Y" != curProp.IS_LOCATION
              )
                for (k = 0; k < this.locations[curProp.ID].length; k++)
                  BX.saleOrderAjax.addPropertyDesc({
                    ...
                    attributes: {
                      ...
                      type: curProp.TYPE,
                      valueSource:
                        "DEFAULT" == curProp.SOURCE ? "default" : "form",
                    },
                  });
              else
                (attrObj = {
        ...
        bindEvents: function () {
          BX.bind(
            ...
            BX.bind(
              window,
              "scroll",
              BX.proxy(this.totalBlockScrollCheck, this)
            ),
            BX.bind(
              window,
              "resize",
        ...
        initFirstSection: function () {
          ...
          firstSection.id != this.basketBlockNode.id &&
        ...
        initOptions: function () {
          ...
          if (
            ...
            (this.propertyCollection = new BX.Sale.PropertyCollection(
              BX.merge({ publicMode: !0 }, this.result.ORDER_PROP)
            )),
            (this.fadedPropertyCollection = new BX.Sale.PropertyCollection(
              BX.merge({ publicMode: !0 }, this.result.ORDER_PROP)
            )),
            this.options.propertyValidation && this.initValidation(),
            this.initPagination(),
            (this.options.showPreviewPicInBasket = !1),
            (this.options.showDetailPicInBasket = !1),
            (this.options.showPropsInBasket = !1),
            (this.options.showPriceNotesInBasket = !1),
            this.result.GRID && this.result.GRID.HEADERS)
          )
            for (
              headers = this.result.GRID.HEADERS, i = 0;
              i < headers.length;
              i++
            )
              "PREVIEW_PICTURE" === headers[i].id &&
                (this.options.showPreviewPicInBasket = !0),
                "DETAIL_PICTURE" === headers[i].id &&
                  (this.options.showDetailPicInBasket = !0),
                "PROPS" === headers[i].id &&
                  (this.options.showPropsInBasket = !0),
                "NOTES" === headers[i].id &&
                  (this.options.showPriceNotesInBasket = !0);
          this.result.TOTAL &&
            ...
            (this.options.showTaxList =
              total.TAX_LIST && total.TAX_LIST.length),
        ...
        reachGoal: function (goal, section) {
          var counter = this.params.YM_GOALS_COUNTER || "",
            useGoals,
            goalId;
          "Y" == this.params.USE_YM_GOALS &&
            void 0 !== window["yaCounter" + counter] &&
          ...
          switch (section.id) {
            case this.basketBlockNode.id:
              goalId = isEdit
                ...
                : this.params.YM_GOALS_MAX_BASKET;
              break;
            case this.regionBlockNode.id:
              goalId = isEdit
                ? this.params.YM_GOALS_EDIT_REGION
                : this.params.YM_GOALS_MAX_REGION;
              break;
            case this.paySystemBlockNode.id:
              goalId = isEdit
                ? this.params.YM_GOALS_EDIT_PAY_SYSTEM
                : this.params.YM_GOALS_MAX_PAY_SYSTEM;
              break;
            case this.deliveryBlockNode.id:
              goalId = isEdit
                ? this.params.YM_GOALS_EDIT_DELIVERY
                : this.params.YM_GOALS_MAX_DELIVERY;
              break;
            case this.pickUpBlockNode.id:
              goalId = isEdit
                ? this.params.YM_GOALS_EDIT_PICKUP
                : this.params.YM_GOALS_MAX_PICKUP;
              break;
            case this.propsBlockNode.id:
              goalId = isEdit
                ? this.params.YM_GOALS_EDIT_PROPERTIES
                : this.params.YM_GOALS_MAX_PROPERTIES;
          }
          return goalId;
        },
        isPriceChanged: function (result) {
          var priceBefore =
              null === this.result.TOTAL.ORDER_TOTAL_LEFT_TO_PAY ||
              "" === this.result.TOTAL.ORDER_TOTAL_LEFT_TO_PAY
                ? this.result.TOTAL.ORDER_TOTAL_PRICE
                : this.result.TOTAL.ORDER_TOTAL_LEFT_TO_PAY,
            priceAfter =
              null === result.order.TOTAL.ORDER_TOTAL_LEFT_TO_PAY
            ...
            if (
              ...
              for (
                arReserve = this.result.DELIVERY.slice(),
                  pages = Math.ceil(
                    arReserve.length / this.options.deliveriesPerPage
                  ),
                  arPages = [],
                  i = 0;
                i < pages;
                ...
                arPages.push(
                  arReserve.splice(0, this.options.deliveriesPerPage)
                );
              for (
                this.deliveryPagination.pages = arPages, i = 0;
                i < this.result.DELIVERY.length;
                i++
              )
                if ("Y" == this.result.DELIVERY[i].CHECKED) {
              ...
              (this.deliveryPagination.pageNumber =
                ...
                (this.deliveryPagination.show = !0);
            } else
              (this.deliveryPagination.pageNumber = 1),
                (this.deliveryPagination.currentPage = this.result.DELIVERY),
                (this.deliveryPagination.show = !1);
            ...
            if (
              ...
              for (
                arReserve = this.result.PAY_SYSTEM.slice(),
                  pages = Math.ceil(
                    arReserve.length / this.options.paySystemsPerPage
                  ),
                  arPages = [],
                  i = 0;
                i < pages;
                ...
                arPages.push(
                  arReserve.splice(0, this.options.paySystemsPerPage)
                );
              for (
                this.paySystemPagination.pages = arPages, i = 0;
                i < this.result.PAY_SYSTEM.length;
                i++
              )
                if ("Y" == this.result.PAY_SYSTEM[i].CHECKED) {
        ...
        initPickUpPagination: function () {
          ...
          if (this.options.pickUpsPerPage >= 0 && this.result.DELIVERY)
            for (i = 0; i < this.result.DELIVERY.length; i++)
              if (
                "Y" === this.result.DELIVERY[i].CHECKED &&
            ...
            if (this.options.pickUpsPerPage > 0 && usePickUpPagination) {
              for (
                arReserve = stores.slice(),
                  pages = Math.ceil(
                    arReserve.length / this.options.pickUpsPerPage
                  ),
                  arPages = [],
                  i = 0;
                i < pages;
              ...
              for (
                this.pickUpPagination.pages = arPages, i = 0;
                i < stores.length;
                i++
              )
                if (
              ...
              this.pickUpPagination.pageNumber ||
                ...
                (this.pickUpPagination.show = !0);
            } else
              (this.pickUpPagination.pageNumber = 1),
                (this.pickUpPagination.currentPage = stores),
                (this.pickUpPagination.show = !1);
        },
        prepareLocations: function (locations) {
          ...
          if (
            ((this.locations = {}),
            (this.cleanLocations = {}),
            BX.util.object_keys(locations).length)
          )
            for (i in locations)
              if (locations.hasOwnProperty(i)) {
                for (k in ((this.locationsTemplate =
                  locations[i].template || ""),
                (temporaryLocations = []),
                (output = locations[i].output).clean &&
                  ((this.cleanLocations[i] = BX.processHTML(output.clean, !1)),
                  delete output.clean),
                output))
                  output.hasOwnProperty(k) &&
        ...
        locationsCompletion: function () {
          var i,
            ...
            data,
            section;
          for (i in ((this.locationsInitialized = !0),
          this.fixLocationsStyle(
              ...
              clearButton &&
                BX.bind(clearButton, "click", function (e) {
                  ...
                  parent &&
                    ...
                    locationInput && BX.fireEvent(locationInput, "keyup");
                }),
              !this.firstLoad &&
                this.options.propertyValidation &&
                (inputStep &&
                  ...
                  (section = BX.findParent(locationNode, {
                    ...
                    "true" == section.getAttribute("data-visited") &&
                    this.isValidProperty(data)),
                inputSearch && BX.fireEvent(inputSearch, "keyup")));
          this.firstLoad &&
          this.result.IS_AUTHORIZED &&
          void 0 === this.result.LAST_ORDER_DATA.FAIL
            ? this.showActualBlock()
            : this.result.SHOW_AUTH || this.changeVisibleContent(),
            this.checkNotifications(),
            this.activeSectionId !== this.regionBlockNode.id &&
              this.editFadeRegionContent(
                this.regionBlockNode.querySelector(".bx-soa-section-content")
              ),
            this.activeSectionId != this.propsBlockNode.id &&
        ...
        clickOrderSaveAction: function (event) {
          return (
            this.isValidForm() &&
              (this.allowOrderSave(),
              "Y" === this.params.USER_CONSENT && BX.UserConsent
        ...
        doSaveAction: function () {
          this.isOrderSaveAllowed() &&
            (this.reachGoal("order"), this.sendRequest("saveOrderAjax"));
        },
        clickNextAction: function (event) {
          ...
          return (
            ...
            (this.result.IS_AUTHORIZED &&
              void 0 === this.result.LAST_ORDER_DATA.FAIL) ||
              "false" != section.next.getAttribute("data-visited") ||
              ((allSections = this.orderBlockNode.querySelectorAll(
                ".bx-soa-section.bx-active"
              )),
              section.next.id == allSections[allSections.length - 1].id &&
                this.switchOrderSaveButtons(!0)),
        ...
        showAuthBlock: function () {
          ...
          showNode &&
            !BX.hasClass(showNode, "bx-selected") &&
            (fadeNode && this.fade(fadeNode), this.show(showNode));
        },
        ...
        shouldSkipSection: function (section) {
          ...
          if ("Y" === this.params.SKIP_USELESS_BLOCK) {
            if (section.id === this.pickUpBlockNode.id) {
              ...
              delivery &&
                (skip = 1 === this.getPickUpInfoArray(delivery.STORE).length);
            }
            section.id === this.deliveryBlockNode.id &&
              (skip =
                this.result.DELIVERY &&
                1 === this.result.DELIVERY.length &&
                0 === this.result.DELIVERY[0].EXTRA_SERVICES.length &&
                !this.result.DELIVERY[0].CALCULATE_ERRORS),
              section.id === this.paySystemBlockNode.id &&
                (skip =
          ...
          for (i = 0; i < allSections.length; i++)
            if (allSections[i].id === actionSection.id && allSections[i + 1])
              return (
                ...
                this.shouldSkipSection(nextSection)
                  ? (this.markSectionAsCompleted(nextSection),
                    this.getNextSection(nextSection, nextSection))
                  : {
                      prev: actionSection,
                      next: nextSection,
                      skip: skippedSection,
        ...
        markSectionAsCompleted: function (section) {
          (this.result.IS_AUTHORIZED &&
            void 0 === this.result.LAST_ORDER_DATA.FAIL) ||
            "false" !== section.getAttribute("data-visited") ||
            this.changeVisibleSection(section, !0),
          ...
          for (i = 0; i < allSections.length; i++)
            if (allSections[i].id === actionSection.id && allSections[i - 1])
              return (
                ...
                this.shouldSkipSection(prevSection)
                  ? (this.markSectionAsCompleted(prevSection),
                    this.getPrevSection(prevSection))
                  : { prev: actionSection, next: prevSection }
              );
          return { next: actionSection };
        },
          ...
          if (node && node.id && this.activeSectionId == node.id) {
            ...
            if (
              ...
              var windowScrollTop = BX.GetWindowScrollPos().scrollTop,
                ...
                nextSectionHidden,
                offset;
              ((nextSectionHidden = BX(nextSection.id + "-hidden")).style.left =
                "-10000"),
                ...
                BX(node.id + "-hidden").parentNode.appendChild(
                  nextSectionHidden
                ),
                ...
                (diff =
                  ...
                  objHeightOrig -
                  nextSectionHeightBefore),
                (offset = window.innerHeight - orderPos.height - diff) > 0
                  ? (scrollTo = orderPos.top - offset / 2)
                  : (scrollTo =
                      nodePos.top > windowScrollTop
                        ? nodePos.top
                        : nodePos.bottom + 6 - objHeightOrig + objHeight) +
                      window.innerHeight >
                      orderPos.bottom + 25 + diff &&
                    (scrollTo =
                      orderPos.bottom + 25 + diff - window.innerHeight),
            ...
            new BX.easing({
              ...
              step: function (state) {
                (node.style.height = state.height + "px"),
                  nextSection && window.scrollTo(0, state.scrollTop);
              },
              complete: function () {
                node.style.height = "";
              },
          ...
          if (node && node.id && this.activeSectionId != node.id) {
            switch (
              ...
              case this.regionBlockNode.id:
                ...
                break;
              case this.deliveryBlockNode.id:
                this.editActiveDeliveryBlock(!0);
                break;
              case this.paySystemBlockNode.id:
            ...
            "false" === node.getAttribute("data-visited") &&
              (this.showBlockErrors(node), this.notifyAboutWarnings(node)),
        ...
        showByClick: function (event) {
          var target = event.target || event.srcElement,
            ...
            scrollTop = BX.GetWindowScrollPos().scrollTop;
          return !showNode || BX.hasClass(showNode, "bx-selected")
            ? BX.PreventDefault(event)
            : (this.reachGoal("edit", showNode),
              this.show(showNode),
              setTimeout(
                BX.delegate(function () {
                  BX.pos(showNode).top < scrollTop &&
        ...
        showActualBlock: function () {
          for (
            ...
            if (
              (allSections[i].id === this.regionBlockNode.id &&
                this.isValidRegionBlock(),
              allSections[i].id === this.propsBlockNode.id &&
                this.isValidPropertiesBlock(),
              !this.checkBlockErrors(allSections[i]) ||
                !this.checkPreload(allSections[i]))
            ) {
              this.activeSectionId !== allSections[i].id &&
                (BX(this.activeSectionId) &&
        ...
        getBlockFooter: function (node) {
          var sections = this.orderBlockNode.querySelectorAll(
            ...
            isLastNode = !1,
            buttons = [];
          currentSection.id == this.basketBlockNode.id &&
            (currentSection && currentSection.id.indexOf(firstSection.id),
            currentSection &&
              "-1" != currentSection.id.indexOf(lastSection.id) &&
              (isLastNode = !0));
        },
        ...
        switchOrderSaveButtons: function (state) {
          var orderSaveNode = this.orderSaveBlockNode,
            ...
            lastState;
          ("" == this.orderSaveBlockNode.style.display) != state &&
            state &&
        ...
        shouldBeSectionVisible: function (sections, currentPosition) {
          ...
          for (; currentPosition < sections.length; currentPosition++) {
            if (
              "true" == sections[currentPosition].getAttribute("data-visited")
            ) {
              state = !0;
              break;
            }
            if (
              ...
              "none" !== editStepNode.style.display
            ) {
              state = !0;
              break;
            }
        ...
        changeVisibleContent: function () {
          var sections = this.orderBlockNode.querySelectorAll(
            ...
            orderDataLoaded =
              !!this.result.IS_AUTHORIZED &&
              "Y" === this.params.USE_PRELOAD &&
              !0 !== this.result.LAST_ORDER_DATA.FAIL,
            skipFlag = !0;
          for (i = 0; i < sections.length; i++)
            (state =
              (state = this.firstLoad && orderDataLoaded) ||
              this.shouldBeSectionVisible(sections, i)),
          ...
          (this.result.IS_AUTHORIZED &&
            void 0 === this.result.LAST_ORDER_DATA.FAIL) ||
            "final_step" !== this.params.SHOW_ORDER_BUTTON ||
        ...
        editOrder: function () {
          if (this.orderBlockNode && this.result) {
            ...
            var sections = this.orderBlockNode.querySelectorAll(
              ...
              i;
            for (i in sections)
              sections.hasOwnProperty(i) && this.editSection(sections[i]);
            this.editTotalBlock(),
              this.totalBlockFixFont(),
              this.showErrors(this.result.ERROR, !1),
              this.showWarnings();
          }
        },
        editSection: function (section) {
          if (section && section.id) {
            ...
            section.id != this.basketBlockNode.id
              ...
              : section.id != this.pickUpBlockNode.id &&
                (section.style.display = "");
            var active =
                section.id != this.basketBlockNode.id ||
                section.id == this.activeSectionId,
              titleNode = section.querySelector(
            ...
            switch (
              ...
              (this.hasErrorSection[section.id] =
                errorContainer && "none" != errorContainer.style.display),
              section.id)
            ) {
              case this.authBlockNode.id:
                this.editAuthBlock();
          ...
          if (this.authBlockNode) {
            ...
            BX.hasClass(authContent, "reg")
              ...
              this.result.SHOW_AUTH
                ...
                : (BX.onCustomEvent("OnBasketChange"), this.closeAuthBlock()),
              this.result.OK_MESSAGE &&
                this.result.OK_MESSAGE.length &&
                (this.toggleAuthForm({
                  target:
                    this.authBlockNode.querySelector("input[type=submit]"),
                }),
        ...
        createAuthFormInputContainer: function (
          labelText,
          inputNode,
          required
        ) {
            ...
            new BX.PhoneAuth({
              ...
              onError: function (response) {
                var errorDiv = BX("bx_register_error"),
                  errorNode = BX.findChildByClassName(errorDiv, "errortext");
                errorNode.innerHTML = "";
        ...
        editRegistrationForm: function (authContent) {
          if (this.result.AUTH) {
            var authFormNodes = [],
              showSmsConfirm =
                this.result.SMS_AUTH && "OK" === this.result.SMS_AUTH.TYPE;
            showSmsConfirm
              ? (authFormNodes.push(
                  BX.create("DIV", {
                    props: { className: "alert alert-success" },
              ...
              : (authFormNodes.push(
                ...
                authFormNodes.push(
                  this.createAuthFormInputContainer(
                    ...
                    "Y" == this.result.AUTH.new_user_email_required
                  )
                ),
                "Y" === this.result.AUTH.new_user_phone_auth &&
                  authFormNodes.push(
                    this.createAuthFormInputContainer(
                    ...
                    BX.create("LABEL", {
                      ...
                      events: {
                        change: BX.delegate(function () {
                          var generated;
                          (this.authBlockNode.querySelector(
                            ".generated"
                          ).style.display = ""),
                            (this.authGenerateUser = !1);
                        }, this),
                      },
                    })
                  ),
                ...
                "Y" == this.result.AUTH.captcha_registration &&
                  authFormNodes.push(
                    BX.create("DIV", {
                      props: { className: "bx-authform-formgroup-container" },
                      children: [
        ...
        editSocialContent: function (authContent) {
          if (BX("bx-soa-soc-auth-services")) {
            ...
            if (!1 === this.socServiceHiddenNode) {
              var socServiceHiddenNode = BX(
                "bx-soa-soc-auth-services"
              ).querySelector(".bx-authform-social");
              BX.type.isDomNode(socServiceHiddenNode) &&
            ...
            this.socServiceHiddenNode &&
              ...
              nodes.push(
                BX.create("hr", { props: { className: "bxe-light" } })
              )),
              "Y" === this.result.AUTH.new_user_registration &&
                nodes.push(
                  BX.create("DIV", {
                    props: { className: "bx-soa-reg-block" },
                    children: [
                      BX.create("P", {
                        html: this.params.MESS_REGISTRATION_REFERENCE,
                      }),
                      BX.create("A", {
              ...
              section.appendChild(
                BX.create("DIV", {
                  ...
                  children: [
                    BX.create("h2", {
                      props: {
                        className: "bx-soa-section-title col-xs-7 col-sm-9",
                      },
            ...
            if (windowSize.innerWidth > 580 && windowSize.innerWidth < 992) {
              if (
                ...
                if (
                  ...
                  "" != columnNodes[0].style.width
                )
                  return;
                if ((columns = columnNodes.length) > 0)
                  for (
        ...
        editActiveBasketBlock: function (activeNodeMode) {
          ...
          this.initialized.basket
            ...
            : ((basketContent = node.querySelector(".bx-soa-section-content")),
              ...
              this.editBasketItems(basketTable, !0),
              ...
              "Y" === this.params.SHOW_COUPONS_BASKET &&
        ...
        editFadeBasketBlock: function (activeNodeMode) {
          ...
          this.initialized.basket ||
            ...
            this.editBasketItems(basketTable, !1),
        ...
        editBasketItems: function (basketItemsNode, active) {
          if (this.result.GRID.ROWS) {
            var index = 0,
              i;
            for (i in ("Y" === this.params.SHOW_BASKET_HEADERS &&
              this.editBasketItemsHeader(basketItemsNode),
            this.result.GRID.ROWS))
              this.result.GRID.ROWS.hasOwnProperty(i) &&
        ...
        editBasketItemsHeader: function (basketItemsNode) {
          if (basketItemsNode) {
            ...
            for (i = 0; i < this.result.GRID.HEADERS.length; i++)
              "NAME" !== (column = this.result.GRID.HEADERS[i]).id &&
                "PREVIEW_PICTURE" !== column.id &&
                "PROPS" !== column.id &&
                "NOTES" !== column.id &&
                ("DETAIL_PICTURE" !== column.id ||
                ...
                4 == ++basketColumnIndex &&
                  this.result.GRID.HEADERS[i + 1] &&
                  (headers.push(
                    BX.create("DIV", {
                      props: { className: "bx-soa-item-nth-4p1" },
                    })
                  ),
                  (basketColumnIndex = 0)));
        ...
        createBasketItem: function (basketItemsNode, item, index, active) {
          ...
          for (
            (this.options.showPreviewPicInBasket ||
              ...
              i = 0;
            i < this.result.GRID.HEADERS.length;
            i++
          )
            "NAME" !== (currentColumn = this.result.GRID.HEADERS[i]).id &&
              "PREVIEW_PICTURE" !== currentColumn.id &&
              "PROPS" !== currentColumn.id &&
              "NOTES" !== currentColumn.id &&
              ("DETAIL_PICTURE" !== currentColumn.id ||
                this.options.showPreviewPicInBasket) &&
              (otherColumns.push(
          ...
          var dopClassServices = "",
            withServices =
              void 0 !== item.data.LINK_SERVICES &&
              item.data.LINK_SERVICES.constructor === Object;
          "Y" === item.data.IS_SERVICES &&
            (dopClassServices += " hidden_order_services "),
            withServices && (dopClassServices += " w_order_services "),
            basketItemsNode.appendChild(
              BX.create("TR", {
                props: {
                  className:
                    ...
                    dopClassServices +
                    (0 == index ? " bx-soa-item-tr-first" : ""),
                },
                children: cols,
              })
            );
          var servicesItems = [];
          (countCols = dopColCount + countCols + 1),
            withServices &&
              ((servicesItems = this.createServicesBasketItem(
                item,
                countCols
        ...
        createBasketItemImg: function (data) {
          ...
          if (data)
            return (
              ...
              data.PREVIEW_PICTURE_SRC && data.PREVIEW_PICTURE_SRC.length
                ? (logotype = this.getImageSources(data, "PREVIEW_PICTURE"))
                : data.DETAIL_PICTURE_SRC &&
                  data.DETAIL_PICTURE_SRC.length &&
              ...
              logotype && logotype.src_2x
                ...
                : ((logotype =
                    (logotype && logotype.src_1x) ||
                    this.defaultBasketItemLogo),
                  logoNode.setAttribute(
                    "style",
                    "background-image: url(" + logotype + ");"
                  )),
              "Y" !== this.params.HIDE_DETAIL_PAGE_URL &&
        ...
        createBasketItemContent: function (data) {
          ...
          if (
            ...
            this.options.showPropsInBasket && props.length)
          )
            for (var i in props)
          ...
          for (var key in servicesInfo) {
            var infoHtml = [
                ...
                BX.create("SPAN", {
                  ...
                  html:
                    servicesInfo[key].QUANTITY +
                    "&nbsp;" +
                    servicesInfo[key].MEASURE_TEXT,
                }),
              ],
              priceHtml = [
                BX.create("SPAN", {
            ...
            "Y" === servicesInfo[key].NEED_SHOW_OLD_SUM &&
              priceHtml.push(
                BX.create("SPAN", {
              ...
              arrServicesDiv.push(
                BX.create("TR", {
                  props: {
                    className: "services_order_item " + classImgPadding,
                  },
                  children: [
                    BX.create("TD", {
                      ...
                      children: [
                        BX.create("DIV", {
                          props: {
                            className: "services_order_item_info_inner",
                          },
                          children: infoHtml,
                        }),
                      ],
                    ...
                    BX.create("TD", {
                      props: { className: "services_order_item_price" },
                      children: priceHtml,
                    }),
                  ],
                })
        ...
        createBasketItemColumn: function (column, allData, active) {
          if (column && allData) {
            var data = allData.columns[column.id]
                ? allData.columns
                : allData.data,
              toRight = BX.util.in_array(column.id, [
                "QUANTITY",
            ...
            if ("PRICE_FORMATED" === column.id)
              textNode.appendChild(
                ...
                this.options.showPriceNotesInBasket &&
                  active &&
                  (textNode.appendChild(BX.create("BR")),
                  textNode.appendChild(
                    BX.create("SMALL", { text: data.NOTES })
                  ));
            else if ("SUM" === column.id)
              textNode.appendChild(
                BX.create("STRONG", {
            ...
            else if ("DETAIL_PICTURE" === column.id)
              ...
              textNode.appendChild(
                BX.create("SPAN", { html: data[column.id] })
              );
            else if ("PREVIEW_TEXT" === column.id)
              "html" === data.PREVIEW_TEXT_TYPE
                ? textNode.appendChild(
              ...
              if (BX.type.isArray(columnData)) {
                for (var i in columnData)
                  columnData.hasOwnProperty(i) &&
                    ("image" == columnData[i].type
                      ? val.push(
                      ...
                      : "linked" == columnData[i].type
                      ? (textNode.appendChild(
                          BX.create("SPAN", {
                            html: columnData[i].value_format,
                          })
                        ),
                        textNode.appendChild(BX.create("BR")))
                      : columnData[i].value &&
                ...
                columnData &&
                  textNode.appendChild(
                    BX.create("SPAN", {
                      html: BX.util.htmlspecialchars(columnData),
                    })
                  );
            }
            return BX.create("TD", {
              ...
              children: [
                BX.create("DIV", {
                  props: {
                    className: "bx-soa-item-td-title visible-xs visible-sm",
                  },
                  text: column.name,
                }),
                textNode,
                ...
                if (BX.type.isArray(columnData)) {
                  for (i in columnData)
                    if (columnData.hasOwnProperty(i))
                      ...
                      else if ("linked" == columnData[i].type)
                        textNode.appendChild(
                          BX.create("SPAN", {
                            html: columnData[i].value_format,
                          })
                    ...
                    load: function () {
                      ...
                      if (content) {
                        ...
                        BX.cleanNode(content),
                          ...
                          contentHeight > windowSize.innerHeight * ratio &&
                            ((content.style.height =
                              windowSize.innerHeight * ratio + "px"),
                            (content.style.width =
                              contentWidth *
                                ((windowSize.innerHeight * ratio) /
                                  contentHeight) +
                              "px"),
                            (contentHeight = content.offsetHeight),
                            (contentWidth = content.offsetWidth)),
                          contentWidth > windowSize.innerWidth * ratio &&
                            ((content.style.width =
                              windowSize.innerWidth * ratio + "px"),
                            (content.style.height =
                              contentHeight *
                                ((windowSize.innerWidth * ratio) /
                                  contentWidth) +
                              "px")),
        ...
        editCoupons: function (basketItemsNode) {
          var couponsList = this.getCouponsList(!0),
            couponsLabel = this.getCouponsLabel(!0),
        ...
        editCouponsFade: function (basketItemsNode) {
          if (!(this.result.COUPON_LIST.length < 1)) {
            var couponsList = this.getCouponsList(!1),
              couponsLabel,
              couponsBlock;
            couponsList.length &&
              ((couponsLabel = this.getCouponsLabel(!1)),
              (couponsBlock = BX.create("DIV", {
                props: { className: "bx-soa-coupon-block" },
                children: [
                  BX.create("DIV", {
              ...
              basketItemsNode.appendChild(
                BX.create("DIV", {
                  props: {
                    className: "bx-soa-coupon bx-soa-coupon-item-fixed",
                  },
        ...
        getCouponsList: function (active) {
          ...
          for (i = 0; i < this.result.COUPON_LIST.length; i++)
            (active ||
              (!active && "APPLIED" == this.result.COUPON_LIST[i].JS_STATUS)) &&
              couponsList.push(
                this.getCouponNode(
                  {
        ...
        removeCoupon: function (coupon) {
          ...
          for (i in couponNodes)
            couponNodes.hasOwnProperty(i) && BX.remove(couponNodes[i]);
        },
        ...
        editFadeRegionBlock: function () {
          var regionContent = this.regionBlockNode.querySelector(
            ...
            newContent;
          this.initialized.region ||
            (this.editActiveRegionBlock(!1),
            BX.remove(BX.lastChild(this.regionBlockNode))),
            (newContent = this.getNewContainer(!0)),
        ...
        editFadeRegionContent: function (node) {
          if (node && this.locationsInitialized) {
            var selectedPersonType = this.getSelectedPersonType(),
              ...
              locationString,
              validRegionErrors;
            errorNode && node.appendChild(errorNode.cloneNode(!0)),
              "true" == this.regionBlockNode.getAttribute("data-visited") &&
                ((validRegionErrors = this.isValidRegionBlock()).length
        ...
        getSelectedPersonType: function () {
          ...
          if (
            ...
            for (i in ((personTypeId = personTypeInput.value),
            this.result.PERSON_TYPE))
        ...
        getDeliveryLocationInput: function (node) {
          ...
          for (k in this.result.ORDER_PROP.properties)
            if (
              this.result.ORDER_PROP.properties.hasOwnProperty(k) &&
              "Y" ==
          ...
          if (
            ...
            currentLocation.SCRIPT))
              currentLocation.SCRIPT.hasOwnProperty(k) &&
        ...
        getZipLocationInput: function (node) {
          ...
          for (i in this.result.ORDER_PROP.properties)
            if (
              ...
              "Y" == this.result.ORDER_PROP.properties[i].IS_ZIP
            ) {
          ...
          zipProperty &&
            ...
            })).setAttribute("data-property-id-row", zipProperty.ID),
            (labelTextHtml =
              "Y" == zipProperty.REQUIRED
                ? '<span class="bx-authform-starrequired">*</span> '
                : ""),
        ...
        getPersonTypeSortedArray: function (objPersonType) {
          ...
          for (k in objPersonType)
            objPersonType.hasOwnProperty(k) &&
            ...
            if (
              ...
              for (i in this.result.PERSON_TYPE)
                this.result.PERSON_TYPE.hasOwnProperty(i) &&
                  ...
                  delimiter && node.appendChild(BX.create("BR")),
                  node.appendChild(
                    BX.create("DIV", {
        ...
        getProfilesControl: function (node) {
          ...
          if (profilesLength)
            if (
              ...
              (profilesLength > 1 || "Y" === this.params.ALLOW_NEW_PROFILE)
            ) {
              for (i in ((this.regionBlockNotEmpty = !0),
              (label = BX.create("LABEL", {
                props: { className: "bx-soa-custom-label" },
              ...
              "Y" === this.params.ALLOW_NEW_PROFILE &&
                options.unshift(
                  BX.create("OPTION", {
                    props: { value: 0 },
              ...
              for (i in this.result.USER_PROFILES)
                this.result.USER_PROFILES.hasOwnProperty(i) &&
                  "Y" === this.result.USER_PROFILES[i].CHECKED &&
                  node.appendChild(
                    BX.create("INPUT", {
                      props: {
                        name: "PROFILE_ID",
        ...
        editActivePaySystemBlock: function (activeNodeMode) {
          ...
          if (this.initialized.paySystem);
            ...
            if (
              ((paySystemContent = node.querySelector(
                ".bx-soa-section-content"
              ))
              ...
              "Y" == this.params.SHOW_COUPONS_PAY_SYSTEM &&
                (this.editCoupons(paySystemContent),
                !this.couponsCustomInitialized))
            ) {
              var divs = BX.findChildren(BX("bx-soa-coupon"), {
                className: "bx-soa-section-content",
              });
              divs &&
                divs.length &&
                ...
                (this.couponsCustomInitialized = !0));
            }
        ...
        editFadePaySystemBlock: function () {
          var paySystemContent = this.paySystemBlockNode.querySelector(
            ...
            newContent;
          this.initialized.paySystem ||
            (this.editActivePaySystemBlock(!1),
        ...
        editPaySystemItems: function (paySystemNode) {
          if (this.result.PAY_SYSTEM && !(this.result.PAY_SYSTEM.length <= 0)) {
            var paySystemItemsContainer = BX.create("DIV", {
              ...
              paySystemItemNode,
              i,
              paySystemItemsDescription = BX.create("DIV", {
            ...
            for (i = 0; i < this.paySystemPagination.currentPage.length; i++)
              (paySystemItemNode = this.createPaySystemItem(
                ...
                paySystemItemsContainer.appendChild(paySystemItemNode),
                "Y" == this.paySystemPagination.currentPage[i].CHECKED &&
                  (paySystemItemsDescription.innerHTML =
                    this.paySystemPagination.currentPage[i].DESCRIPTION);
            this.paySystemPagination.show &&
              this.showPagination("paySystem", paySystemItemsContainer),
        ...
        createPaySystemItem: function (item) {
          ...
          return (
            ...
            "Y" == this.params.SHOW_PAY_SYSTEM_LIST_NAMES &&
              (title = BX.create("DIV", {
            ...
            (itemNode = BX.create("DIV", {
              props: {
                className:
                  "bx-soa-pp-company bx-soa-pp-company-item col-lg-4 col-sm-4 col-xs-6",
              },
        ...
        editPaySystemInfo: function (paySystemNode) {
          if (
            ...
            var injectNodes = BX.findChildren(
                this.paySystemBlockNode,
                { className: "bx-soa-pp-company-inject" },
                !0
              ),
              paySystemNode;
            ...
            if (currentPaySystem)
              if (
                ...
                paySystemNode.length
              ) {
                var injectNode = BX.findChildren(
                  paySystemNode[0],
                  { className: "bx-soa-pp-company-inject" },
                  !0
                );
        ...
        getInnerPaySystem: function () {
          if (
            ...
            var accountOnly =
                ...
                "Y" == this.params.ONLY_FULL_PAY_FROM_ACCOUNT,
              isSelected =
                this.result.PAY_CURRENT_ACCOUNT &&
                "Y" == this.result.PAY_CURRENT_ACCOUNT,
            ...
            return (
              ...
              BX.create("DIV", {
                props: {
                  className:
                    "bx-soa-pp-inner-ps" + (isSelected ? " bx-selected" : ""),
                },
                children: [subTitle],
              })
            );
        ...
        editFadePaySystemContent: function (node) {
          var selectedPaySystem = this.getSelectedPaySystem(),
            ...
            imgSrc;
          errorNode
            ? node.appendChild(errorNode.cloneNode(!0))
            : this.getErrorContainer(node),
            warningNode &&
              warningNode.innerHTML &&
              node.appendChild(warningNode.cloneNode(!0)),
            this.isSelectedInnerPayment() ||
              (selectedPaySystem && selectedPaySystem.NAME) ||
              (addedHtml =
        ...
        getSelectedPaySystem: function () {
          ...
          if (
            ...
            for (
              paySystemId = paySystemCheckbox.value, i = 0;
              i < this.result.PAY_SYSTEM.length;
              i++
            )
        ...
        isSelectedInnerPayment: function () {
          ...
          return (
            innerPaySystemCheckbox ||
              (innerPaySystemCheckbox =
                this.paySystemHiddenBlockNode.querySelector(
                  "input[type=checkbox][name=PAY_CURRENT_ACCOUNT]"
                )),
            innerPaySystemCheckbox && innerPaySystemCheckbox.checked
          );
        },
          ...
          if (this.orderBlockNode && event) {
            var target = event.target || event.srcElement,
              ...
              fullPayFromInnerPaySystem =
                this.result.TOTAL &&
                0 === parseFloat(this.result.TOTAL.ORDER_TOTAL_LEFT_TO_PAY),
              innerPsAction = BX.hasClass(target, "bx-soa-pp-inner-ps")
                ? target
            ...
            if (innerPsAction)
              "INPUT" == target.nodeName &&
                ...
                innerPaySystemCheckbox.checked
                  ? (BX.removeClass(innerPaySystemSection, "bx-selected"),
                    (innerPaySystemCheckbox.checked = !1))
                  : (BX.addClass(innerPaySystemSection, "bx-selected"),
                    (innerPaySystemCheckbox.checked = !0));
              ...
              fullPayFromInnerPaySystem
                ? (BX.addClass(actionSection, "bx-selected"),
                  ((actionInput = actionSection.querySelector(
                    "input[type=checkbox]"
                  )).checked = !0),
                  BX.removeClass(innerPaySystemSection, "bx-selected"),
                  (innerPaySystemCheckbox.checked = !1))
        ...
        editActiveDeliveryBlock: function (activeNodeMode) {
          ...
          if (this.initialized.delivery);
            ...
            if (
              ...
              "Y" == this.params.SHOW_COUPONS_DELIVERY &&
        ...
        editDeliveryInfo: function (deliveryNode) {
          if (this.result.DELIVERY) {
            ...
            "Y" != this.params.DELIVERY_NO_AJAX &&
        ...
        getDeliveryPriceNodes: function (delivery) {
          ...
          return (priceNodesArray =
            void 0 !== delivery.DELIVERY_DISCOUNT_PRICE &&
        ...
        getDeliveryExtraServices: function (delivery) {
          ...
          for (i in delivery.EXTRA_SERVICES)
            delivery.EXTRA_SERVICES.hasOwnProperty(i) &&
              (currentService = delivery.EXTRA_SERVICES[i]).canUserEditValue &&
              (-1 == currentService.editControl.indexOf("this.checked")
                ? ((serviceName = BX.create("LABEL", {
                  ...
                  input && BX.addClass(input, "form-control"))
                : (serviceNode = BX.create("DIV", {
          ...
          return brake && extraServices.unshift(BX.create("BR")), extraServices;
        },
        editFadeDeliveryBlock: function () {
          ...
          if (
            ...
            divs &&
              divs.length &&
              (BX.cleanNode(divs[0]), this.editCoupons(divs[0]));
          }
        },
        createDeliveryItem: function (item) {
          var checked = "Y" == item.CHECKED,
            ...
            injectNode,
            bHasPrice = !1;
          item.PRICE >= 0 || void 0 !== item.DELIVERY_DISCOUNT_PRICE
            ? ((bHasPrice = !0),
              (costNode = BX.create("DIV", {
                ...
                html:
                  ...
                  ':</div><div class="bx-soa-pp-list-description" lang="ru">' +
                  (item.PRICE > 0
                    ? void 0 !== item.DELIVERY_DISCOUNT_PRICE
            ...
            : deliveryCached &&
              (deliveryCached.PRICE >= 0 ||
                void 0 !== deliveryCached.DELIVERY_DISCOUNT_PRICE) &&
              ((bHasPrice = !0),
              (costNode = BX.create("DIV", {
                props: { className: "bx-soa-pp-delivery-cost" },
                html:
            ...
            "Y" == this.params.SHOW_DELIVERY_LIST_NAMES &&
              (title = BX.create("DIV", {
                props: { className: "bx-soa-pp-company-smalltitle" },
                text:
                  "N" != this.params.SHOW_DELIVERY_PARENT_NAMES
                    ? item.NAME
                    : item.OWN_NAME,
              })).setAttribute("lang", "ru"),
          ...
          var bHasCalculate =
            "CALCULATE_DESCRIPTION" in item &&
            item.CALCULATE_DESCRIPTION.length;
          return (
            bHasCalculate &&
        ...
        selectDelivery: function (event) {
          if (this.orderBlockNode) {
            var target = event.target || event.srcElement,
              actionCompany = BX.findParent(target, {
                className: "bx-soa-pp-company-inject",
              }),
              actionSection = BX.hasClass(target, "bx-soa-pp-company-item")
                ? target
                : BX.findParent(target, {
                    className: "bx-soa-pp-company-item",
                  }),
            ...
            if (!actionCompany) {
              ...
              actionSection &&
                ...
                BX.addClass(actionSection, "bx-selected"),
                (actionInput.checked = !0)),
                selectedSection &&
                  ((selectedInput = selectedSection.querySelector(
                    "input[type=checkbox]"
                  )),
                  BX.removeClass(selectedSection, "bx-selected"),
                  (selectedInput.checked = !1)),
                (this.isDeliveryChanged = !0),
                this.sendRequest();
            }
          }
        },
        getSelectedDelivery: function () {
          ...
          if (
            ...
            for (i in ((deliveryId = deliveryCheckbox.value),
            this.result.DELIVERY))
        ...
        activatePickUp: function (deliveryName) {
          this.pickUpBlockNode &&
            ...
            (this.pickUpBlockNode.querySelector(
        ...
        editPickUpBlock: function (active) {
          this.pickUpBlockNode &&
            ...
            BX.hasClass(this.pickUpBlockNode, "bx-active") &&
            this.result.DELIVERY &&
            ((this.initialized.pickup = !1),
            active
              ? this.editActivePickUpBlock(!0)
              : this.editFadePickUpBlock(),
            (this.initialized.pickup = !0));
        },
        editActivePickUpBlock: function (activeNodeMode) {
          var node = activeNodeMode
            ...
            pickUpContent,
            pickUpContentCol;
          this.initialized.pickup
            ? ("Y" === this.params.SHOW_NEAREST_PICKUP &&
                this.maps &&
                !this.maps.maxWaitTimeExpired &&
                ((this.maps.maxWaitTimeExpired = !0),
                this.initPickUpPagination(),
                this.editPickUpList(!0),
                this.pickUpFinalAction()),
              this.maps &&
                !this.pickUpMapFocused &&
                ((this.pickUpMapFocused = !0),
                setTimeout(
                  BX.proxy(this.maps.pickUpMapFocusWaiter, this.maps),
                  200
                )))
            : ((pickUpContent = node.querySelector(
                ".bx-soa-section-content"
              )) ||
        ...
        getPickUpInfoArray: function (storeIds) {
          ...
          for (i = 0; i < storeIds.length; i++)
            this.result.STORE_LIST[storeIds[i]] &&
        ...
        getSelectedPickUp: function () {
          ...
          if (
            pickUpInput &&
            !(currentPickUp = allStoresList[(pickUpId = pickUpInput.value)]) &&
        ...
        geoLocationSuccessCallback: function (result) {
          ...
          currentDelivery &&
            ...
            activeStores &&
              activeStores.length >=
                this.options.pickUpMap.minToShowNearestBlock &&
              result &&
        ...
        initMaps: function () {
          if (
            ...
            if (
              ...
              "Y" === this.params.SHOW_PICKUP_MAP && BX("pickUpMap"))
            ) {
              var currentDelivery = this.getSelectedDelivery();
              if (
                currentDelivery &&
                ...
                var activeStores = this.getPickUpInfoArray(
                  currentDelivery.STORE
                );
        ...
        getPropertyMapData: function () {
          var currentProperty,
            locationId,
            k,
            data = this.options.propertyMap.defaultMapPosition;
          for (k in this.result.ORDER_PROP.properties)
            if (
              this.result.ORDER_PROP.properties.hasOwnProperty(k) &&
              "Y" ==
        ...
        editPickUpList: function (isNew) {
          if (
            ...
            var pickUpList = BX.create("DIV", {
              ...
              storeNode;
            if (
              (buyerStoreInput && (selectedStore = buyerStoreInput.value),
              ...
              for (i = 0; i < selectedDelivery.STORE.length; i++)
                selectedDelivery.STORE[i] == selectedStore && (found = !0);
            for (i = 0; i < this.pickUpPagination.currentPage.length; i++)
              ((currentStore = this.pickUpPagination.currentPage[i]).ID !=
                selectedStore &&
                0 != parseInt(selectedStore) &&
                found) ||
        ...
        pickUpFinalAction: function () {
          ...
          selectedDelivery &&
            ...
            (this.lastSelectedDelivery = parseInt(selectedDelivery.ID))),
            deliveryChanged &&
              this.pickUpBlockNode.id !== this.activeSectionId &&
              (this.pickUpBlockNode.id !== this.activeSectionId &&
          ...
          return (
            "Y" === this.params.SHOW_STORES_IMAGES
              ? ((logotype = this.getImageSources(currentStore, "IMAGE_ID")),
                (imgSrc =
                  (logotype && logotype.src_1x) || this.defaultStoreLogo),
                (logoNode = BX.create("IMG", {
                  props: { src: imgSrc, className: "bx-soa-pickup-l-item-img" },
                  events: {
                    click: BX.delegate(function (e) {
                      this.popupShow(
                        e,
                        (logotype && logotype.src_orig) || imgSrc
                      );
                    }, this),
                  },
                })))
                  ...
                  children: [
                    BX.create("A", {
                      ...
                      html: options.selected
                        ? this.params.MESS_SELECTED_PICKUP
                        : this.params.MESS_SELECT_PICKUP,
                      events: {
                        click: BX.delegate(function (event) {
                          this.selectStore(event), this.clickNextAction(event);
                        }, this),
                      },
                    }),
                  ],
            ...
            options.selected && BX.addClass(storeNode, "bx-selected"),
            storeNode
          );
        },
        editPickUpRecommendList: function (geoLocation) {
          if (this.maps && this.maps.canUseRecommendList() && geoLocation) {
            ...
            var recommendList = BX.create("DIV", {
              ...
              container,
              recommendedStoreIds =
                this.maps.getRecommendedStoreIds(geoLocation);
        ...
        selectStore: function (event) {
          ...
          if (BX.type.isString(event)) {
            if (!(storeItem = BX("store-" + event))) {
              for (i = 0; i < this.pickUpPagination.pages.length; i++)
                for (
                  page = this.pickUpPagination.pages[i], k = 0;
                  k < page.length;
                  k++
                )
                  if (page[k].ID == event) {
          ...
          if (storeItem && storeInput) {
            ...
            (storeItemId = storeItem.id.substr("store-".length)),
              (selectedPickUp =
                this.pickUpBlockNode.querySelector(".bx-selected")) &&
                ((selectedPickUp.querySelector(
                  ".bx-soa-pickup-l-item-btn .btn"
                ).innerText = this.params.MESS_SELECT_PICKUP),
              ...
              (storeItem.querySelector(
                ".bx-soa-pickup-l-item-btn .btn"
              ).innerText = this.params.MESS_SELECTED_PICKUP),
              new BX.easing({
                duration: 300,
        ...
        getDeliverySortedArray: function (objDelivery) {
          ...
          for (k in objDelivery)
            objDelivery.hasOwnProperty(k) &&
              ("L" === this.params.SHOW_NOT_CALCULATED_DELIVERIES &&
          ...
          return (
            ...
            deliveries.concat(problemDeliveries)
          );
        },
        editPropsBlock: function (active) {
          this.propsBlockNode &&
            this.propsHiddenBlockNode &&
            this.result.ORDER_PROP &&
            (active ? this.editActivePropsBlock(!0) : this.editFadePropsBlock(),
            (this.initialized.props = !0));
        },
        editActivePropsBlock: function (activeNodeMode) {
          ...
          if (this.initialized.props)
            this.maps &&
              setTimeout(
                BX.proxy(this.maps.propsMapFocusWaiter, this.maps),
                200
              );
          else {
            if (
            ...
            this.editPropsItems(propsNode),
              ...
              "Y" !== this.params.HIDE_ORDER_DESCRIPTION &&
            ...
            for (
              ...
              for (
                ...
                this.deliveryLocationInfo.loc != property.getId() &&
                  ...
                  this.getPropertyRowNode(property, propsItemsContainer, !1);
            ...
            (disabled
              ...
              : (BX.addClass(propsItemNode, "form-group bx-soa-customer-field"),
                ...
                propertyDesc.length &&
                  ...
                  (textHtml +=
                    " <small>(" +
                    BX.util.htmlspecialchars(propertyDesc) +
                    ")</small>"),
                (label = BX.create("LABEL", {
                  attrs: { for: "soa-property-" + property.getId() },
                  props: { className: "bx-soa-custom-label" },
                  // Добавил проверку на адрес заказа
                  html:
                    property.getId() === "64"
                      ? textHtml +
                        ". Указывайте, пожалуйста, корректный адрес. Это важно для доставки вашего заказа."
                      : textHtml,
                })),
                propsItemNode.setAttribute(
                  "data-property-id-row",
                  property.getId()
                ),
                propsItemNode.appendChild(label)),
            propertyType)
          ...
          if (property.getId() in this.locations)
            if (disabled) {
              if (
                ...
                for (
                  propNodes = propRow.querySelectorAll("div.bx-soa-loc"), i = 0;
                  i < propNodes.length;
                  i++
                )
              ...
              for (
                ...
                for (k in ((currentLocation = propRow[i]
                  ? propRow[i].output
                  : {}),
                (insertedLoc = BX.create("DIV", {
                ...
                property.isMultiple() &&
                  (insertedLoc.style.marginBottom =
                    "search" == this.locationsTemplate ? "5px" : "20px"),
        ...
        addLocationProperty: function (e) {
          ...
          if (
            (BX.hasClass(lastProp, "bx-soa-loc") &&
              ("search" == this.locationsTemplate
            ...
            for (k in ((insertedLoc = BX.create("DIV", {
              ...
              html: this.cleanLocations[propId].HTML.split("#key#")
                .join(index)
                .replace(/sls-\d{5}/g, "sls-" + randomStr),
            })),
            ...
            this.cleanLocations[propId].SCRIPT))
              this.cleanLocations[propId].SCRIPT.hasOwnProperty(k) &&
                BX.evalGlobal(
        ...
        insertFileProperty: function (property, propsItemNode, disabled) {
          ...
          if (disabled) {
            if (
              ...
              for (
                values = [], fileLinks = prop.querySelectorAll("a"), i = 0;
                i < fileLinks.length;
                i++
              )
                (html = fileLinks[i].innerHTML).length && values.push(html);
              propsItemNode.innerHTML += this.valuesToString(values);
            }
          } else
            (saved = this.savedFilesBlockNode.querySelector(
              ...
              (propContainer = saved.querySelector(
                "div.soa-property-container"
              )),
              propContainer
                ? propsItemNode.appendChild(propContainer)
                : ((propContainer = BX.create("DIV", {
          ...
          if (disabled) {
            if (
              ...
              if (
                ((values = []),
                0 ==
                  (inputs = prop.querySelectorAll("input[type=text]")).length &&
                  (inputs = prop.querySelectorAll("textarea")),
                inputs.length)
              )
                for (i = 0; i < inputs.length; i++)
                  inputs[i].value.length && values.push(inputs[i].value);
              propsItemNode.innerHTML += this.valuesToString(values);
            }
          } else
            (propContainer = BX.create("DIV", {
        ...
        insertEnumProperty: function (property, propsItemNode, disabled) {
          ...
          if (disabled) {
            if (
              ...
              if (
                ((values = []),
                (inputs = prop.querySelectorAll("input[type=radio]")).length)
              )
                for (i = 0; i < inputs.length; i++)
                  inputs[i].checked &&
                    values.push(inputs[i].nextSibling.nodeValue);
              if ((inputs = prop.querySelectorAll("option")).length)
                for (i = 0; i < inputs.length; i++)
                  inputs[i].selected && values.push(inputs[i].innerHTML);
              propsItemNode.innerHTML += this.valuesToString(values);
            }
          } else
            (propContainer = BX.create("DIV", {
        ...
        alterProperty: function (settings, propContainer) {
          ...
          var divs = BX.findChildren(propContainer, { tagName: "DIV" }),
            ...
            fileTitles;
          if (divs && divs.length)
            for (i = 0; i < divs.length; i++) divs[i].style.margin = "5px 0";
          for (
          ...
          for (
            inputs = propContainer.querySelectorAll("select"), i = 0;
            i < inputs.length;
            i++
          )
            BX.addClass(inputs[i], "form-control");
          for (
            inputs = propContainer.querySelectorAll("textarea"), i = 0;
            i < inputs.length;
            i++
          )
            (inputs[i].placeholder =
              settings.DESCRIPTION +
              "Пример: г. Пятигорск, ул. Февральская, 54"),
              BX.addClass(inputs[i], "form-control bx-ios-fix");
          for (
            del = propContainer.querySelectorAll("label"), i = 0;
            i < del.length;
            i++
          )
            BX.remove(del[i]);
          if ("FILE" == settings.TYPE) {
            ...
            for (
              fileTitles = propContainer.querySelectorAll("a"), i = 0;
              i < fileTitles.length;
              i++
            )
          ...
          for (
            add = propContainer.querySelectorAll("input[type=button]"), i = 0;
            i < add.length;
            i++
          )
            BX.addClass(add[i], "btn btn-default btn-sm"),
              ("Y" == settings.MULTIPLE && i == add.length - 1) ||
                ("FILE" == settings.TYPE &&
            ...
            BX.bind(
              ...
              BX.delegate(function (e) {
                var target = e.target || e.srcElement,
                  ...
                  textInputs =
                    targetContainer.querySelectorAll("input[type=text]"),
                ...
                if (
                  ...
                  textInputs.length &&
                    ...
                    settings.PATTERN &&
                      settings.PATTERN.length &&
                      textInputs[textInputs.length - 1].removeAttribute(
                        "pattern"
                      )),
                  textAreas.length &&
                  ...
                  if (settings.ACCEPT && settings.ACCEPT.length)
                    for (
                      fileInputs =
                        propContainer.querySelectorAll("input[type=file]"),
                        accepts = this.getFileAccepts(settings.ACCEPT),
                        i = 0;
                      i < fileInputs.length;
                      i++
                  ...
                  (fileTitles = targetContainer.querySelectorAll("a")),
                    BX.bind(
                      fileTitles[fileTitles.length - 1],
                      "click",
                      function (e) {
                        var target = e.target || e.srcElement,
                          fileInput =
        ...
        alterDateProperty: function (settings, inputText) {
          ...
          BX.addClass(parentNode, "input-group"),
            (addon = BX.create("DIV", {
              ...
              children: [
                BX.create("I", { props: { className: "bx-calendar" } }),
              ],
            })),
          ...
          if (
            ...
            if (this.activeSectionId == this.propsBlockNode.id) {
              for (
                ...
                if ("opened" == tooltips[i].getAttribute("data-state")) {
          ...
          return (
            regionErrors.length
              ...
              : ((this.regionBlockNode.querySelector(
                ...
                BX.cleanNode(
                  this.regionBlockNode.querySelector(".alert.alert-danger")
                ),
                BX.removeClass(this.regionBlockNode, "bx-step-error")),
            propsErrors.length
              ? (this.showError(this.propsBlockNode, propsErrors),
                BX.addClass(this.propsBlockNode, "bx-step-error"))
              : ((this.propsBlockNode.querySelector(
                  ".alert.alert-danger"
                ).style.display = "none"),
                BX.cleanNode(
                  this.propsBlockNode.querySelector(".alert.alert-danger")
                ),
                BX.removeClass(this.propsBlockNode, "bx-step-error")),
            !(regionErrors.length + propsErrors.length)
          );
        },
        isValidRegionBlock: function () {
          ...
          for (i = 0; i < regionProps.length; i++)
            (id = regionProps[i].getAttribute("data-property-id-row")),
              ...
              (regionErrors = regionErrors.concat(
                this.isValidProperty(data, !0)
              ));
          return regionErrors;
        },
        isValidPropertiesBlock: function (excludeLocation) {
          ...
          for (i = 0; i < props.length; i++)
            (id = props[i].getAttribute("data-property-id-row")),
              (excludeLocation && this.locations[id]) ||
                ((propContainer = props[i].querySelector(
        ...
        isValidProperty: function (data, fieldName) {
          ...
          for (i = 0; i < data.inputs.length; i++)
            (inputErrors = data.func(data.inputs[i], !!fieldName)).length &&
              (propErrors[i] = inputErrors.join("<br>"));
          return this.showValidationResult(data.inputs, propErrors), propErrors;
        },
          ...
          if (arProperty && propContainer) {
            ...
            switch (arProperty.TYPE) {
              case "STRING":
                ...
                (inputs = propContainer.querySelectorAll("textarea")).length &&
                  (data.inputs = inputs);
                break;
              case "LOCATION":
                if (
                ...
                (inputs = propContainer.querySelectorAll("div.bx-ui-slst-pool"))
                  .length && (data.inputs = inputs);
                break;
              case "Y/N":
                (data.inputs = propContainer.querySelectorAll(
                  "input[type=checkbox]"
                )),
                  (data.action = "change"),
                  (data.func = BX.delegate(function (input, fieldName) {
              ...
              case "NUMBER":
                (data.inputs =
                  propContainer.querySelectorAll("input[type=text]")),
                  (data.action = "blur"),
                  (data.func = BX.delegate(function (input, fieldName) {
              ...
              case "ENUM":
                if (
                  ((inputs =
                    propContainer.querySelectorAll("input[type=radio]"))
                    .length ||
                    (inputs = propContainer.querySelectorAll(
                      "input[type=checkbox]"
                    )),
                ...
                (inputs = propContainer.querySelectorAll("option")).length &&
                  ((data.inputs = [inputs]),
                  (data.action = "click"),
                  (data.func = BX.delegate(function (input, fieldName) {
        ...
        showErrorTooltip: function (tooltipId, targetNode, text) {
          if (tooltipId && targetNode && text) {
            ...
            (text = this.uniqueText(text, "<br>")),
              ...
              // Добавил тернарный оператор для выделения ошибки в адресе доставки
              tooltipId == "soa-property-64"
                ? (tooltipInner.innerHTML =
                    "Указывайте, пожалуйста, корректный адрес. Это важно для доставки вашего заказа.")
                : (tooltipInner.innerHTML = text),
              "opened" != tooltip.getAttribute("data-state") &&
        ...
        showValidationResult: function (inputs, errors) {
          if (inputs && inputs.length && errors) {
            var input0 = BX.type.isElementNode(inputs[0])
                ? inputs[0]
                : inputs[0][0],
              formGroup,
              ...
              i;
            for (
              label && (tooltipId = label.getAttribute("for")), i = 0;
              i < inputs.length;
              i++
            )
            ...
            : ("Y" === arProperty.REQUIRED &&
              ...
              value.length &&
                ...
                value.length > 0 &&
                  ...
                  ((re = new RegExp(arProperty.PATTERN)).test(value) ||
                    errors.push(
                      field + " " + BX.message("SOA_INVALID_PATTERN")
                    ))),
              errors);
        },
        validateLocation: function (input, arProperty, fieldName) {
          ...
          var parent = BX.findParent(input, {
            ...
            field = fieldName
              ? BX.message("SOA_FIELD") +
                ' "' +
                BX.util.htmlspecialchars(arProperty.NAME) +
                '"'
              : BX.message("SOA_FIELD");
          return "Y" == arProperty.MULTIPLE && "Y" !== arProperty.IS_LOCATION
            ? errors
            : ("Y" != arProperty.REQUIRED ||
                (0 != value.length &&
                  value != BX.message("SOA_NOT_SPECIFIED")) ||
                errors.push(field + " " + BX.message("SOA_REQUIRED")),
              errors);
        },
          ...
          return "Y" == arProperty.MULTIPLE
            ...
            : ("Y" == arProperty.REQUIRED &&
              ...
              value.length &&
                ...
                arProperty.MIN &&
                  parseFloat(arProperty.MIN) > parseFloat(value) &&
                  errors.push(
                    BX.message("SOA_MIN_VALUE") +
                      ' "' +
                      name +
                      '" ' +
                ...
                arProperty.MAX &&
                  parseFloat(arProperty.MAX) < parseFloat(value) &&
                  errors.push(
                    BX.message("SOA_MAX_VALUE") +
                      ' "' +
                      name +
                      '" ' +
                      parseFloat(arProperty.MAX)
                  ),
                arProperty.STEP &&
                  parseFloat(arProperty.STEP) > 0 &&
                  (del = (
                    (num = Math.abs(
                      parseFloat(value) -
                        (arProperty.MIN && parseFloat(arProperty.MIN) > 0
                          ? parseFloat(arProperty.MIN)
                          : 0)
                    )) / parseFloat(arProperty.STEP)
                  ).toPrecision(12)) != parseInt(del) &&
                  errors.push(
                    field +
                      " " +
                      BX.message("SOA_NUM_STEP") +
                      " " +
                      arProperty.STEP
                  )),
              errors);
        ...
        validateEnum: function (inputs, arProperty, fieldName) {
          ...
          for (i = 0; i < inputs.length; i++)
            (inputs[i].checked || inputs[i].selected) && values.push(i);
          return (
            "Y" == arProperty.REQUIRED &&
              0 == values.length &&
              errors.push(field + " " + BX.message("SOA_REQUIRED")),
        ...
        validateSelect: function (inputs, arProperty, fieldName) {
          ...
          if ("Y" == arProperty.MULTIPLE) return errors;
          for (i = 0; i < inputs.length; i++)
            inputs[i].selected && values.push(i);
          return (
            "Y" == arProperty.REQUIRED &&
              0 == values.length &&
              errors.push(field + " " + BX.message("SOA_REQUIRED")),
          ...
          if (
            ...
            for (i = 0; i < files.length; i++)
              (file = files[i]),
                ...
                (fileExtension =
                  (splittedName = file.name.split(".")).length > 1
                    ? splittedName[splittedName.length - 1].toLowerCase()
                    : ""),
                arProperty.ACCEPT.length > 0 &&
                  (0 == fileExtension.length ||
                    "-1" == arProperty.ACCEPT.indexOf(fileExtension)) &&
                  errors.push(
                ...
                file.size > parseInt(arProperty.MAXSIZE) &&
                  errors.push(
                    BX.message("SOA_MAX_SIZE") +
                      ' "' +
                      fileName +
                      '" (' +
                      this.getSizeString(arProperty.MAXSIZE, 1) +
                      ")"
                  );
          else errors.push(field + " " + BX.message("SOA_REQUIRED"));
          return errors;
        },
        ...
        editTotalBlock: function () {
          if (this.totalInfoBlockNode && this.result.TOTAL) {
            var total = this.result.TOTAL,
              ...
              deliveryError,
              deliveryValue,
              showOrderButton = "Y" === this.params.SHOW_TOTAL_ORDER_BUTTON,
              totalName;
            if (
              (BX.cleanNode(this.totalInfoBlockNode),
              0 === parseFloat(total.ORDER_PRICE)
              ...
              this.options.showPriceWithoutDiscount &&
                (priceHtml +=
                  ...
                  "</span>"),
              (totalName = this.result.SERVICES_IN_ORDER
                ? BX.message("SOA_SUM_SUMMARY_WITH_SERVICES")
                : BX.message("SOA_SUM_SUMMARY")),
              this.totalInfoBlockNode.appendChild(
                this.createTotalUnit(totalName, priceHtml, params)
              ),
              this.options.showOrderWeight &&
                this.totalInfoBlockNode.appendChild(
        ...
        editMobileTotalBlock: function () {
          this.result.SHOW_AUTH
            ...
            this.mobileTotalBlockNode.appendChild(
              this.totalInfoBlockNode.cloneNode(!0)
            ),
            BX.bind(
              this.mobileTotalBlockNode.querySelector(
        ...
        createTotalUnit: function (name, value, params) {
          ...
          return (
            (name = name || ""),
            (value = value || ""),
            (totalValue = (params = params || {}).error
              ? [
                  BX.create("A", {
              ...
              : [value]),
            params.total && (className += " bx-soa-cart-total-line-total"),
            params.highlighted &&
        ...
        basketBlockScrollCheckEvent: function (e) {
          var target = e.target || e.srcElement,
            ...
            scrollRight =
              target.scrollWidth - (scrollLeft + target.clientWidth),
        ...
        basketBlockScrollCheck: function () {
          ...
          for (i = 0; i < scrollableNodes.length; i++)
            (tableNode = (parentNode = scrollableNodes[i]).querySelector(
              "table.bx-soa-item-table"
            )),
              (parentWidth = parentNode.clientWidth),
              (tableWidth = tableNode.clientWidth || 0),
              (scrollable = scrollable || tableWidth > parentWidth)
                ? ((scrollLeft = (scrollNode = BX.firstChild(parentNode))
                    .scrollLeft),
                  (scrollRight =
                    scrollNode.scrollWidth -
                    (scrollLeft + scrollNode.clientWidth)),
                  0 == scrollLeft
        ...
        totalBlockScrollCheck: function () {
          if (this.totalInfoBlockNode && this.totalGhostBlockNode) {
            ...
            headerFixed &&
              BX.hasClass(headerFixed, "fixed") &&
              (offset = headerFixed.offsetHeight + 20),
              ghostBottom - this.totalBlockNode.offsetHeight < scrollTop + 20
                ? BX.addClass(
                    this.totalInfoBlockNode,
        ...
        totalBlockFixFont: function () {
          ...
          totalNode &&
            ...
            "Y" == this.params.SHOW_TOTAL_ORDER_BUTTON &&
            ...
            objList.length &&
              BX.FixFontSize.init({ objList: objList, onAdaptiveResize: !0 });
        },
          ...
          if (this.params.DATA_LAYER_NAME) {
            ...
            for (i in this.result.GRID.ROWS)
              if (this.result.GRID.ROWS.hasOwnProperty(i)) {
                for (
                  item = this.result.GRID.ROWS[i], dataVariant = [], i = 0;
                  i < item.data.PROPS.length;
                  i++
                )
                ...
                products.push({
                  ...
                  brand: (
                    item.data[this.params.BRAND_PROPERTY + "_VALUE"] || ""
                  )
                    .split(", ")
                    .join("/"),
